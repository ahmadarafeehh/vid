...
class _PostCardState extends State<PostCard>
  ...
  void _toggleVideoPlayback() {
    if (_isVideoPlaying) {
      ...
      // Auto-hide the pause icon after 3 seconds
      ...
      _playVideo();
      // Hide the play button after a brief delay
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            icon: Icon(Icons.send, color: colors.textColor),
  ...
  Widget _buildMediaSection(_ColorSet colors) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Use video player for videos, image viewer for images
        _isVideo
  ...
  Widget _buildCommentButton(_ColorSet colors) {
    return Stack(
      ...
      children: [
        IconButton(
          icon: Icon(Icons.comment_outlined, color: colors.textColor),
...
// Video Upload Functionality - Add this new class
class VideoUploadHelper {
  ...
  static Future<String?> uploadVideo(File videoFile, String postId) async {
    try {
      // Compress video if needed (you can add video compression here)
  ...
  static Future<File> _compressVideo(File videoFile) async {
    ...
    // You can use packages like flutter_ffmpeg for video compression
    // For now, return the original file
    return videoFile;
  }
}

// SINGLE RatingListScreen class definition
