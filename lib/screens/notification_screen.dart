...
class _ReplyLikeNotification extends StatelessWidget {
  ...
  final dynamic Function(String) getField;
  final Map<String, Map<String, dynamic>> userCache;
  final _NotificationColorSet colors; // Add this field

  const _ReplyLikeNotification({
    required this.notification,
    required this.getField,
    required this.userCache,
    required this.colors, // Add this parameter
  });
  ...
  Widget build(BuildContext context) {
    ...
    return _NotificationTemplate(
      ...
      userCache: userCache,
      colors: colors, // Add this parameter
    );
  }
}
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => ImageViewScreen(
            ...
            datePublished:
                postData['datePublished'], // <--- pass this from your snap
          ),
        ),
      );
    }
